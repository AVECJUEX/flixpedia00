				    ...
				    <div class="row" style="justify-content:center">
				        <div class="col-md-6">
				            ...
				            <div class="row mt-2">
				                ...
				                <input readonly="readonly" type="text" class="form-control" placeholder="받는이" id="name1" name="name1"
				                value="<%=dto.getToname()%>" >
				                </div>
				                <div class="col-md-6">
				                <label class="labels">id</label>
				                <input readonly="readonly" type="text" class="form-control" placeholder="ID" id="id" name="id"
				                value="<%=dto.getId()%>" >
				                </div>
				            </div>
				            <div class="row mt-2">
				                ...
				                <input readonly="readonly" type="text" class="form-control" placeholder="보내는이" id="name2" name="name2"
				                value="<%=dto.getFromname()%>" >
				                </div>
				            </div>
				            <div class="row mt-3">
				                <div class="col-md-12">
