					...
					<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
						<div class="card">
							<div class="card__cover">
								...
								<img src="${commonURL}/resources/movie_img/<%=dto.getMovie_images() %>" style="height: 230px;object-fit: cover;">
...
function goSearch(){
	...
	frm.pg.value=0;
	frm.action = "<%=request.getContextPath()%>/movie/list";
	frm.method="get";
	frm.submit();
}
...
function goPage(pg)
{
	...
	frm.pg.value=pg;///////////
	frm.method="get";
	frm.action="${pageContext.request.contextPath}/movie/list";
	frm.submit();
}
